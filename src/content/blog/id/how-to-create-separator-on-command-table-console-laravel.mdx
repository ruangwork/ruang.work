...
authors:
    - id/inurhuda00
excerpt: 'Kita bisa menggunakan Command Table untuk membuat tabel yang bisa kita gunakan untuk menampilkan data secara terstruktur di dalam console Laravel'
topics: ['coding']
tags:
    - laravel
    - php
