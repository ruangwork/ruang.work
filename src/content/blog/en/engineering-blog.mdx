...
authors:
    - inurhuda00
desc: 'Astro Starter Kit: Multilanguague Blog'
topics: ['docs', 'coding']
tags:
    - astro
    - solid
...
# Astro Starter Kit: Multilanguague Blog

This template was built to easily create an Multilanguague blog for one or multiple authors.
