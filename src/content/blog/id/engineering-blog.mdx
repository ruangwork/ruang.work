---
title: "README: Apa saja yang disertakan dalam templat Blog Teknik ini?"
date: 2023-05-24
authors:
  - inurhuda00
desc: "Astro Starter Kit: Blog Multilanguague"
topics: ["docs", "coding"]
tags:
  - astro
  - solid
...
# Astro Starter Kit: Blog Multilanguague

Templat ini dibuat untuk membuat blog Multilanguague dengan mudah untuk satu atau beberapa penulis.
...
```
npm create astro@latest -- --template inurhuda/tassimo
```

### Konfigurasi

Edit nilai dalam `src/consts.ts` untuk mencocokkan merek atau perusahaan Anda:

```ts
export const BRAND = "RW";
export const SITE_TITLE = "Ruang Work";
export const SITE_URL = "";
export const SITE_DESCRIPTION = "Welcome to the ruang work";
export const PAGINATION_POSTS_PER_PAGE = 5;
```

Change any lines or add more in the `<head>` tags in `src/components/meta/head.astro`, like the favicon:
